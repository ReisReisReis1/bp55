"""
Django settings for bp55_ruins_and_beyond project.
...
ALLOWED_HOSTS = ["ruinsandbeyond.architektur.tu-darmstadt.de", '127.0.0.1']
...
WSGI_APPLICATION = 'bp55_ruins_and_beyond.wsgi.application'
