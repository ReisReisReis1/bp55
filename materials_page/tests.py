...
from materials_page.views import get_categories_and_corresponding_files, \
    get_categories_and_corresponding_zip_files
...
class MaterialTestCases(TestCase):
    ...
    def test1__str__(self):
        ...
        Material.objects.create(name='TestDatei1', file='/media/material/Test1.pdf',
                                category='TestKategorie1')
        Material.objects.create(name='TestDatei2', file='/media/material/Test2.pdf',
                                category='TestKategorie1')
        Material.objects.create(name='TestDatei3', file='/media/material/Test3.pdf',
    ...
    def test2_get_categories_and_corresponding_files(self):
        ...
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie1'][0].name,
                         'TestDatei1')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie1'][1].name,
                         'TestDatei2')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie2'][0].name,
                         'TestDatei3')
        self.assertEqual(get_categories_and_corresponding_files()[''][0].name, '')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie1'][0].file,
                         '/media/material/Test1.pdf')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie1'][1].file,
                         '/media/material/Test2.pdf')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie2'][0].file,
                         '/media/material/Test3.pdf')
        self.assertEqual(get_categories_and_corresponding_files()[''][0].file, '')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie1'][0].category,
                         'TestKategorie1')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie1'][1].category,
                         'TestKategorie1')
        self.assertEqual(get_categories_and_corresponding_files()['TestKategorie2'][0].category,
                         'TestKategorie2')
    ...
    def test3_get_categories_and_corresponding_zip_files(self):
        ...
        Material.objects.create(name='TestDatei2',
                                ...
                                category='TestKategorie1')
        Material.objects.create(name='TestDatei3',
                                file='C:/Users/Laura Buhleier/Documents/GitHub/media/Test3.pdf',
                                category='TestKategorie2')

        try:
            file = io.BytesIO(
                get_categories_and_corresponding_zip_files()['TestKategorie1'].content)
        ...
        try:
            file = io.BytesIO(
                get_categories_and_corresponding_zip_files()['TestKategorie2'].content)
            zipped_file = zipfile.ZipFile(file, 'r')
            self.assertIsNone(zipped_file.testzip())
